  ...
  <v-container>
    ...
    >
      ...
      <v-window v-model="step">
        ...
        <!--          <v-card-text>-->
        <!--            <UploadComponent/>-->
        <!--            &lt;!&ndash;            <span class="text-caption text-grey-darken-1">&ndash;&gt;-->
        <!--            &lt;!&ndash;            Загрузите фото&ndash;&gt;-->
        <!--            &lt;!&ndash;          </span>&ndash;&gt;-->
        <!--          </v-card-text>-->
        <!--        </v-window-item>-->
...
const validateData = async () => {
  const result = await v$.value.$validate(v$.value.$invalid)
  if (!result) {
    console.log('error')
  } else {
    console.log('nice dick')
    step.value++
  }
}
